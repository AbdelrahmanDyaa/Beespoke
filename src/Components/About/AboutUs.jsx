  ...
  return (
    <div className="bg-darkBg text-lightText font-oswald min-h-screen py-16 px-6 md:px-20 lg:px-32">
      ...
      <section className="text-center mb-20 relative mt-10">
        <h1 className="text-5xl md:text-6xl font-bold text-darkText mb-10">
          Bespoke Spaces
        </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {overviewPoints.map((point, index) => (
              <div key={index} className="relative pl-6">
                ...
                <div className="bg-backgroundAlt/20 backdrop-blur-md rounded-2xl p-6 text-darkBrown text-lg leading-relaxed hover:scale-[1.02] transition-transform duration-300">
                  {point}
                </div>
              </div>
            ))}
      ...
      <section className="mb-10 text-center">
        <h2 className="text-4xl text-darkText mb-12 tracking-wide font-bold uppercase">
